...
""));
        ...
        widget_2->setGeometry(QRect(220, 240, 301, 381));
...
""));
        ...
        gridLayout->addWidget(editUsername, 2, 0, 1, 1);
        ...
        gridLayout->addWidget(editEmail, 3, 0, 1, 1);
        ...
        gridLayout->addWidget(editPasswordYes, 5, 0, 1, 1);
        ...
        gridLayout->addWidget(editPassword, 4, 0, 1, 1);
...
"}"));
        ...
        gridLayout->addWidget(errTip, 1, 0, 1, 1);
    ...
    void retranslateUi(QMainWindow *zhuceMainWindow)
    {
        ...
        errTip->setText(QCoreApplication::translate("zhuceMainWindow", "\346\240\274\345\274\217\346\255\243\347\241\256", nullptr));
    } // retranslateUi
